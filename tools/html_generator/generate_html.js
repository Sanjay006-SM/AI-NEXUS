...
const markdownFile = 'Handbook/markdown/Sentinel_AI_Handbook.md';
const outputFile = 'Handbook/html/Sentinel_AI_Handbook.html';
...
<head>
    ...
    <title>SentinelAI Handbook</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <p><strong>SentinelAI Handbook</strong></p>
        </div>
        ${htmlBody}
    </div>
</body>
