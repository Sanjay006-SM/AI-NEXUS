  ...
  return (
    <div className="animate-in fade-in duration-500 pb-12 flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1 text-sm">Trends, heatmaps, and posture across your machine identity surface</p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-12 text-center flex flex-col items-center justify-center gap-4 shadow-sm min-h-[400px]">
        ...
        <h2 className="text-xl font-bold text-slate-800">Advanced Analytics & Posture Trends</h2>
        <p className="text-slate-400 text-sm max-w-md leading-relaxed">
          Historical activity volume trends, geographic anomaly heatmaps, and framework compliance mappings are coming soon in the next release.
        </p>
