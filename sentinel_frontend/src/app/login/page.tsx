      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {!isGoogleConfigured ? (
              <div className="col-span-2 p-3 text-xs text-red-500 bg-red-50 border border-red-200 rounded-xl text-center">
                Google Auth not configured in .env.local
              </div>
            ) : (
              <>
                <button type="button" onClick={triggerGoogleAuth} className="landing-btn-ghost h-11 flex items-center justify-center gap-2 rounded-xl transition-colors">
